...
Blockly.C.lists_create_with = function() {
  ...
  code =  'size_t arrayTemp[] = {' + code.join(', ') + '}';
...
Blockly.C.lists_repeat = function() {
  ...
  var code =  Blockly.C.lists_repeat.repeat + '(' + argument0 + ', ' + argument1 + ')';
  return [code, Blockly.Dart.ORDER_UNARY_POSTFIX];
};

Blockly.C.lists_length = function() {
  // Testing the length of a list is the same as for a string.
  return Blockly.C.text_length.call(this);
};

Blockly.C.lists_isEmpty = function() {
  // Testing a list for being empty is the same as for a string.
  return Blockly.C.text_isEmpty.call(this);
};

Blockly.C.lists_indexOf = function() {
  // Searching a list for a value is the same as search for a substring.
  return Blockly.C.text_indexOf.call(this);
};

Blockly.C.lists_getIndex = function() {
  // Indexing into a list is the same as indexing into a string.
  return Blockly.C.text_charAt.call(this);
};
